                          ...
                          {message.user === 'Bayard' && isStreaming && message.text === modelOutput ? (
                            ...
                            <ReactMarkdown
                              ...
                              components={{
                                ...
                                h2: ({ node, ...props }) => <h2 style={{ marginBottom: '1rem' }} {...props} />,
                                h3: ({ node, ...props }) => <h3 style={{ marginBottom: '1rem' }} {...props} />,
                                h4: ({ node, ...props }) => <h4 style={{ marginBottom: '1rem' }} {...props} />,
                                h5: ({ node, ...props }) => <h5 style={{ marginBottom: '1rem' }} {...props} />,
                                h6: ({ node, ...props }) => <h6 style={{ marginBottom: '1rem' }} {...props} />,
