                  ...
                  >
                    <Card
                      className={`mb-4 p-4 rounded-lg shadow-md backdrop-filter backdrop-blur-2xl bg-opacity-20 ${
                        message.user === 'You' ? 'bg-amber-100/60 dark:bg-gray-800/60 text-gray-800 dark:text-amber-400' : 'bg-gradient-to-r from-amber-200/60 dark:from-gray-700/60 to-amber-100/60 dark:to-gray-800/60 text-gray-800 dark:text-amber-300'
                      }`}
                    >
                      <CardHeader>
                        <div className="flex items-center justify-between">
